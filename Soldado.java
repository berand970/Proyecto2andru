...
public class Soldado extends Ficha {
    ...
    public boolean mover(int filaInicial, int columnaInicial, int filaFinal, int columnaFinal, Ficha[][] tablero) {
        ...
        if (getPropietario().equals(Tablero.getInstancia().getUsuarioActual().getUser())) {
        ...
        } else if (getPropietario().equals(Tablero.getInstancia().getOponente().getUser())) {
    ...
    public List<int[]> obtenerMovimientosPosibles(int fila, int columna, Ficha[][] tablero) {
        ...
        if ((getPropietario().equals(Tablero.getInstancia().getUsuarioActual().getUser()) && fila <= 4) ||
            (getPropietario().equals(Tablero.getInstancia().getOponente().getUser()) && fila >= 5)) {
